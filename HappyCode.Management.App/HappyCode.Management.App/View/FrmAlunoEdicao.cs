...
{
    public partial class FrmAlunoEdicao : Form
    {
        #region Constructor
        public FrmAlunoEdicao(Aluno obj)
        {
            _obj = obj;
            InitializeComponent();
            InitializeEvents();
        ...
        private void InitializeForms()
        {
            ...
            if (_obj == null)
            {
                _obj = new Aluno() { Dt_Criacao = DateTime.Now, Dt_Nascimento = DateTime.Now, St_Ativo = true };
            }
        ...
        private void CarregarEndereco()
        {
            ...
            {
                Msg.Info("Nao foi possível realizar a busca do endereço... Tente novamente!");
            }
        }
